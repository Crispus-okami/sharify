    ...
    <div class="container">
       ...
       <form action="" method="POST" enctype="multipart/form-data">
        ...
        <?php
            ...
            <input type="text" name="name" value="'.$project['name'].'" class="form-control" required="true">
        ...
        <input type="text" required="true" name="price" value="'.$project['price'].'" class="form-control">
        <input type="text" name="loc" required="true" value="'.$project['location'].'" class="form-control">
